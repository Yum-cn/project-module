package com.project.app.config.shiro.jwt;
...
import com.project.app.util.common.JsonConvertUtil;
import com.project.app.util.common.PropertiesUtil;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean isLoginAttempt(ServletRequest request, ServletResponse response) {
        ...
        if(StringUtils.isEmpty(token)){
        	token = request.getParameter(BasicHttpAuthenticationFilter.AUTHORIZATION_HEADER);
        }
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
    	...
    	String tokenStr = this.getAuthzHeader(request);
    	if(StringUtils.isEmpty(tokenStr)){
    		tokenStr = request.getParameter(BasicHttpAuthenticationFilter.AUTHORIZATION_HEADER);
    	}
        // 拿到当前Header中Authorization的AccessToken(Shiro中getAuthzHeader方法已经实现)
